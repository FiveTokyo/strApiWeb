 ...
 */
export function instanceOfUsersPermissionsRolesGetRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UsersPermissionsRolesGetRequestFromJSON(json: any): UsersPermissionsRolesGetRequest {
    return UsersPermissionsRolesGetRequestFromJSONTyped(json, false);
}

export function UsersPermissionsRolesGetRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsersPermissionsRolesGetRequest {
...
export function UsersPermissionsRolesGetRequestToJSON(value?: UsersPermissionsRolesGetRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
