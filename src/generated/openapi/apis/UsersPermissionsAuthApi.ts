...
export class UsersPermissionsAuthApi extends runtime.BaseAPI {
     ...
     */
    async authForgotPasswordPostRaw(requestParameters: AuthForgotPasswordPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UsersPermissionsRolesGet200Response1>> {
     ...
     * Send rest password email
     */
    async authForgotPasswordPost(requestParameters: AuthForgotPasswordPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UsersPermissionsRolesGet200Response1> {
     ...
     */
    async connectGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Error>> {
        const queryParameters: any = {};
